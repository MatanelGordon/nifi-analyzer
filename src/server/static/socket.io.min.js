...
!(function (t, n) {
					...
					try {
						...
						null === (t = this.l.cookieJar) ||
							...
							this.l.requestTimeout &&
								(e.timeout = this.l.requestTimeout),
			...
			(i.F = function (t, n) {
				if (
					...
					if (
						...
						ct &&
							(this.P &&
								removeEventListener('beforeunload', this.P, !1),
							this.$))
					) {
			...
			return (
				(i.add = function (n) {
					...
					if ('string' == typeof n) {
						...
						var r =
							(i = this.decodeString(n)).type === Bt.BINARY_EVENT;
				...
				(i.decodeString = function (t) {
					...
					if (
						r.type === Bt.BINARY_EVENT ||
						r.type === Bt.BINARY_ACK
					) {
						for (
							var e = i + 1;
			...
			return (
				...
				(o.emit = function (t) {
					...
					return (
						(this.flags.volatile && !c) ||
							(a
								? (this.notifyOutgoingListeners(u),
								  this.packet(u))
				...
				(o.vt = function (t) {
					this.packet({
						type: Bt.CONNECT,
						data: this.lt
							? e({ pid: this.lt, offset: this.dt }, t)
							: t,
					});
				}),
	...
	var Dt = (function (t) {
			function n(n, i) {
				...
				((r = t.call(this) || this).nsps = {}),
					...
					r.randomizationFactor(
						null !== (e = i.randomizationFactor) && void 0 !== e
							? e
							: 0.5
					),
					(r.backoff = new _t({
			...
			return (
				...
				(i.wt = function (t) {
					for (
						var n = 0, i = Object.keys(this.nsps);
						n < i.length;
						n++
					) {
						var r = i[n];
				...
				(i.ct = function (t) {
					for (
						var n = this.encoder.encode(t), i = 0;
						i < n.length;
						i++
					)
